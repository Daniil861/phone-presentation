...
*/
    ...
    const tlH = gsapWithCSS.timeline({
        scrollTrigger: {
            trigger: ".second-page",
            start: "-40%",
            end: "40%",
    ...
    tlH.fromTo(".second-page__text-highlight", {
        color: "rgba(255,255,255,0.4)"
    }, {
        color: "rgba(255,255,255,1)",
        stagger: 1
    });
    const tlHRemove = gsapWithCSS.timeline({
        scrollTrigger: {
            trigger: ".second-page",
            start: "-20%",
            end: "60%",
    ...
    tlHRemove.to(".second-page__text-highlight", {
        color: "rgba(255,255,255,0.4)",
        stagger: 1
    });
    const tlSplit = gsapWithCSS.timeline({
        scrollTrigger: {
            trigger: ".third-page",
            start: "-25%",
            end: "30%",
    ...
    const xOffsetImage = windowWidth > 768 ? 20 : 5;
    const xOffsetText = windowWidth > 768 ? 100 : 20;
    tlSplit.fromTo(".third-page__img-large", {
        x: "0%"
    }, {
        x: `-${xOffsetImage}%`
    });
    tlSplit.fromTo(".third-page__img-small", {
        x: "0%"
    }, {
        x: `${xOffsetImage}%`
    }, "<");
    tlSplit.fromTo(".third-page__text-left", {
        x: `-${1.5 * xOffsetText}`,
        opacity: 0
    }, {
        x: `-${xOffsetText}`,
    ...
    tlSplit.fromTo(".third-page__text-right", {
        x: 1.5 * xOffsetText,
        opacity: 0
    }, {
        x: xOffsetText,
    ...
    const swatches = document.querySelectorAll(".forth-page__swatches img");
    const gallery = document.querySelector(".forth-page__phone-gallery");
    const slides = document.querySelectorAll(".forth-page__gallery-cnt");
    ...
    swatches.forEach(((swatch, idx) => {
        ...
        swatch.addEventListener("click", (e => {
            ...
            let closeUp = document.querySelector(`.forth-page__img-${swatchName}`);
            if (currentSwatch === swatchName) return;
            currentSwatch = swatchName;
            gsapWithCSS.set(closeUp, {
                zIndex: topIndex
            });
            gsapWithCSS.fromTo(closeUp, {
                opacity: 0
            }, {
                opacity: 1,
                duration: 1
    ...
    const tlVideo = gsapWithCSS.timeline({
        scrollTrigger: {
            trigger: ".fifth-page",
            start: "0%",
            end: "100%",
    ...
    tlVideo.fromTo(".fifth-page__video", {
        currentTime: 0
    }, {
        currentTime: 3,
        duration: 1
    });
    tlVideo.fromTo(".fifth-page__info-cnt h3", {
        opacity: 0
    }, {
        opacity: 1,
        stagger: .25
    }, "<");
    const tlParallax = gsapWithCSS.timeline({
        scrollTrigger: {
            trigger: ".sixth-page",
            start: "-25%",
            end: "50%",
    ...
    tlParallax.fromTo(".sixth-page__photo-descr", {
        y: 0
    }, {
        y: -150
    });
    tlParallax.fromTo(".sixth-page__portrait-cnt", {
        y: 0,
        x: 0
    }, {
        y: -150,
    ...
    tlParallax.fromTo(".sixth-page__phone-video", {
        y: 0
    }, {
        y: -200
    }, "<");
